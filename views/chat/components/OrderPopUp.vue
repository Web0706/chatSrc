...
import { addOrder, orderType, orderPriority } from '@renderer/api/order'
import { getVisitorList, upload, projectService } from '@renderer/api/chat'

const userStore = useUserStore()

const addDialogVisible = ref(false)
const orderPriorityList = ref<Dictionary[]>([])
const projectServiceList = ref([])
...
const getSelectList = async () => {
  ...
  orderTypeList.value = orderTypeResponse.data.rows
  visitorList.value = visitorListResponse.data.list.rows
  orderPriorityList.value = orderPriorityResponse.data
  projectServiceList.value = projectServiceResponse.data.rows
}
